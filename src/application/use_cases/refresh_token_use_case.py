...
from src.domain.exceptions import UserNotFound, InvalidRefreshToken, ExpRefreshToken
...
class RefreshTokenUseCase:
    ...
    def __init__(self, user_repo: IUserRepository, access_token: IAccessToken, role_repo: IRoleRepository):
    ...
    async def execute(self, refresh_token: str):
        try:
            payload = self._access_token.decode_access_token(refresh_token)
