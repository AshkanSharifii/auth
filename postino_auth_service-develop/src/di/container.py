...
class Container(containers.DeclarativeContainer):
    ...
    update_user_brand_use_case_provider = providers.Factory(
    ...
    delete_user_brand_use_case_provider = providers.Factory(
    ...
    get_brand_industries_use_case = providers.Factory(
        GetBrandIndustriesUseCase, industry_repo=industry_repository_provider
    )
