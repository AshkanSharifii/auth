...
class GetCurrentUserUseCase:
    ...
    Methods:
        execute(token: str) -> Optional[tuple]:
            Decodes the access token and returns the corresponding user entity and role.
    """
    ...
    async def execute(self, token: str) -> Optional[tuple]:
        ...
        Returns:
            Optional[tuple]: The user entity and user role
